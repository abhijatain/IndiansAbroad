function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/AdminView-CQYkMCzp.js","assets/virtualscroller.esm--4rPf0xP.js","assets/SearchView-BCRI_hbL.js","assets/DiscussionCard-Ctvk_WKw.css","assets/SavedView-DuDGcu9W.js","assets/SavedView-Cgke0cYw.css","assets/DiscusionView-9Rmesrwu.js","assets/CarouselCard-BeGVYOh4.js","assets/DiscusionView-BX3E4SUX.css","assets/AddView-CPBoGBgE.js","assets/AddView-BSFKUHFO.css","assets/SingleView-CtkeYNgT.js","assets/SingleView-Dtj6xbPG.css","assets/HelpView-BasO1hAP.js"]
  }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hm="FirebaseError";class Ht extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=hm,Object.setPrototypeOf(this,Ht.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,yr.prototype.create)}}class yr{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},i=`${this.service}/${e}`,o=this.errors[e],s=o?pm(o,r):"Error",a=`${this.serviceName}: ${s} (${i}).`;return new Ht(i,a,r)}}function pm(t,e){return t.replace(gm,(n,r)=>{const i=e[r];return i!=null?String(i):`<${r}?>`})}const gm=/\{\$([^}]+)}/g;function mm(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function ti(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const i of n){if(!r.includes(i))return!1;const o=t[i],s=e[i];if(tl(o)&&tl(s)){if(!ti(o,s))return!1}else if(o!==s)return!1}for(const i of r)if(!n.includes(i))return!1;return!0}function tl(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vv="firebase-heartbeat-database",bv=1,cr="firebase-heartbeat-store";let to=null;function Tu(){return to||(to=$m(vv,bv,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(cr)}catch(n){console.warn(n)}}}}).catch(t=>{throw Ut.create("idb-open",{originalErrorMessage:t.message})})),to}async function yv(t){try{const n=(await Tu()).transaction(cr),r=await n.objectStore(cr).get(ku(t));return await n.done,r}catch(e){if(e instanceof Ht)on.warn(e.message);else{const n=Ut.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});on.warn(n.message)}}}async function al(t,e){try{const r=(await Tu()).transaction(cr,"readwrite");await r.objectStore(cr).put(e,ku(t)),await r.done}catch(n){if(n instanceof Ht)on.warn(n.message);else{const r=Ut.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});on.warn(r.message)}}}function ku(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Iv(t){lr(new On("platform-logger",e=>new jm(e),"PRIVATE")),lr(new On("heartbeat",e=>new Sv(e),"PRIVATE")),qn(Lo,ol,t),qn(Lo,ol,"esm2017"),qn("fire-js","")}Iv("");function Is(t,e){var n={};for(var r in t)Object.prototype.hasOwnProperty.call(t,r)&&e.indexOf(r)<0&&(n[r]=t[r]);if(t!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(t);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(t,r[i])&&(n[r[i]]=t[r[i]]);return n}function Cu(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Tv=Cu,Au=new yr("auth","Firebase",Cu());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ri=new wu("@firebase/auth");function kv(t,...e){ri.logLevel<=fe.WARN&&ri.warn(`Auth (${wr}): ${t}`,...e)}function Br(t,...e){ri.logLevel<=fe.ERROR&&ri.error(`Auth (${wr}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sr{constructor(e,n){this.shortDelay=e,this.longDelay=n,_t(n>e,"Short delay should be less than long delay!"),this.isMobile=am()||cm()}get(){return Ov()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cs(t,e){_t(t.emulator,"Emulator should always be set here");const{url:n}=t.emulator;return e?`${n}${e.startsWith("/")?e.slice(1):e}`:n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $v(t,e){return Dn(t,"POST","/v1/accounts:delete",e)}async function Ru(t,e){return Dn(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ur(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Ht&&Mv(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function Mv({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vv(t,e){const n=await Pu(t,{},async()=>{const r=_r({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:o}=t.config,s=xu(t,i,"/v1/token",`key=${o}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Ou.fetch()(s,{method:"POST",headers:a,body:r})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}async function Bv(t,e){return Dn(t,"POST","/v2/accounts:revokeToken",As(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(t,e){W(typeof t=="string"||typeof t>"u","internal-error",{appName:e})}class vt{constructor(e){var{uid:n,auth:r,stsTokenManager:i}=e,o=Is(e,["uid","auth","stsTokenManager"]);this.providerId="firebase",this.proactiveRefresh=new jv(this),this.reloadUserInfo=null,this.reloadListener=null,this.uid=n,this.auth=r,this.stsTokenManager=i,this.accessToken=i.accessToken,this.displayName=o.displayName||null,this.email=o.email||null,this.emailVerified=o.emailVerified||!1,this.phoneNumber=o.phoneNumber||null,this.photoURL=o.photoURL||null,this.isAnonymous=o.isAnonymous||!1,this.tenantId=o.tenantId||null,this.providerData=o.providerData?[...o.providerData]:[],this.metadata=new jo(o.createdAt||void 0,o.lastLoginAt||void 0)}async getIdToken(e){const n=await ur(this,this.stsTokenManager.getToken(this.auth,e));return W(n,this.auth,"internal-error"),this.accessToken!==n&&(this.accessToken=n,await this.auth._persistUserIfCurrent(this),this.auth._notifyListenersIfCurrent(this)),n}getIdTokenResult(e){return Dv(this,e)}reload(){return Fv(this)}_assign(e){this!==e&&(W(this.uid===e.uid,this.auth,"internal-error"),this.displayName=e.displayName,this.photoURL=e.photoURL,this.email=e.email,this.emailVerified=e.emailVerified,this.phoneNumber=e.phoneNumber,this.isAnonymous=e.isAnonymous,this.tenantId=e.tenantId,this.providerData=e.providerData.map(n=>Object.assign({},n)),this.metadata._copy(e.metadata),this.stsTokenManager._assign(e.stsTokenManager))}_clone(e){const n=new vt(Object.assign(Object.assign({},this),{auth:e,stsTokenManager:this.stsTokenManager._clone()}));return n.metadata._copy(this.metadata),n}_onReload(e){W(!this.reloadListener,this.auth,"internal-error"),this.reloadListener=e,this.reloadUserInfo&&(this._notifyReloadListener(this.reloadUserInfo),this.reloadUserInfo=null)}_notifyReloadListener(e){this.reloadListener?this.reloadListener(e):this.reloadUserInfo=e}_startProactiveRefresh(){this.proactiveRefresh._start()}_stopProactiveRefresh(){this.proactiveRefresh._stop()}async _updateTokensIfNecessary(e,n=!1){let r=!1;e.idToken&&e.idToken!==this.stsTokenManager.accessToken&&(this.stsTokenManager.updateFromServerResponse(e),r=!0),n&&await ii(this),await this.auth._persistUserIfCurrent(this),r&&this.auth._notifyListenersIfCurrent(this)}async delete(){if(gt(this.auth.app))return Promise.reject(rn(this.auth));const e=await this.getIdToken();return await ur(this,$v(this.auth,{idToken:e})),this.stsTokenManager.clearRefreshToken(),this.auth.signOut()}toJSON(){return Object.assign(Object.assign({uid:this.uid,email:this.email||void 0,emailVerified:this.emailVerified,displayName:this.displayName||void 0,isAnonymous:this.isAnonymous,photoURL:this.photoURL||void 0,phoneNumber:this.phoneNumber||void 0,tenantId:this.tenantId||void 0,providerData:this.providerData.map(e=>Object.assign({},e)),stsTokenManager:this.stsTokenManager.toJSON(),_redirectEventId:this._redirectEventId},this.metadata.toJSON()),{apiKey:this.auth.config.apiKey,appName:this.auth.name})}get refreshToken(){return this.stsTokenManager.refreshToken||""}static _fromJSON(e,n){var r,i,o,s,a,l,c,u;const d=(r=n.displayName)!==null&&r!==void 0?r:void 0,f=(i=n.email)!==null&&i!==void 0?i:void 0,g=(o=n.phoneNumber)!==null&&o!==void 0?o:void 0,b=(s=n.photoURL)!==null&&s!==void 0?s:void 0,S=(a=n.tenantId)!==null&&a!==void 0?a:void 0,x=(l=n._redirectEventId)!==null&&l!==void 0?l:void 0,k=(c=n.createdAt)!==null&&c!==void 0?c:void 0,R=(u=n.lastLoginAt)!==null&&u!==void 0?u:void 0,{uid:j,emailVerified:H,isAnonymous:K,providerData:L,stsTokenManager:Q}=n;W(j&&Q,e,"internal-error");const M=En.fromJSON(this.name,Q);W(typeof j=="string",e,"internal-error"),Ct(d,e.name),Ct(f,e.name),W(typeof H=="boolean",e,"internal-error"),W(typeof K=="boolean",e,"internal-error"),Ct(g,e.name),Ct(b,e.name),Ct(S,e.name),Ct(x,e.name),Ct(k,e.name),Ct(R,e.name);const J=new vt({uid:j,auth:e,email:f,emailVerified:H,displayName:d,isAnonymous:K,photoURL:b,phoneNumber:g,tenantId:S,stsTokenManager:M,createdAt:k,lastLoginAt:R});return L&&Array.isArray(L)&&(J.providerData=L.map(X=>Object.assign({},X))),x&&(J._redirectEventId=x),J}static async _fromIdTokenResponse(e,n,r=!1){const i=new En;i.updateFromServerResponse(n);const o=new vt({uid:n.localId,auth:e,stsTokenManager:i,isAnonymous:r});return await ii(o),o}static async _fromGetAccountInfoResponse(e,n,r){const i=n.users[0];W(i.localId!==void 0,"internal-error");const o=i.providerUserInfo!==void 0?Nu(i.providerUserInfo):[],s=!(i.email&&i.passwordHash)&&!(o!=null&&o.length),a=new En;a.updateFromIdToken(r);const l=new vt({uid:i.localId,auth:e,stsTokenManager:a,isAnonymous:s}),c={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:o,metadata:new jo(i.createdAt,i.lastLoginAt),isAnonymous:!(i.email&&i.passwordHash)&&!(o!=null&&o.length)};return Object.assign(l,c),l}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fl=new Map;function bt(t){_t(t instanceof Function,"Expected a class definition");let e=fl.get(t);return e?(_t(e instanceof t,"Instance stored in cache mismatched with class"),e):(e=new t,fl.set(t,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Hr(t,e,n){return`firebase:${t}:${e}:${n}`}class In{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:i,name:o}=this.auth;this.fullUserKey=Hr(this.userKey,i.apiKey,o),this.fullPersistenceKey=Hr("persistence",i.apiKey,o),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?vt._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new In(bt(hl),e,r);const i=(await Promise.all(n.map(async c=>{if(await c._isAvailable())return c}))).filter(c=>c);let o=i[0]||bt(hl);const s=Hr(r,e.config.apiKey,e.name);let a=null;for(const c of n)try{const u=await c._get(s);if(u){const d=vt._fromJSON(e,u);c!==o&&(a=d),o=c;break}}catch{}const l=i.filter(c=>c._shouldAllowMigration);return!o._shouldAllowMigration||!l.length?new In(o,e,r):(o=l[0],a&&await o._set(s,a.toJSON()),await Promise.all(n.map(async c=>{if(c!==o)try{await c._remove(s)}catch{}})),new In(o,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bu(t,e=[]){let n;switch(t){case"Browser":n=pl(Pe());break;case"Worker":n=`${pl(Pe())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${wr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kv(t,e={}){return Dn(t,"GET","/v2/passwordPolicy",As(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function nb(t,e){const n=Eu(t,"auth");if(n.isInitialized()){const i=n.getImmediate(),o=n.getOptions();if(ti(o,e??{}))return i;ct(i,"already-initialized")}return n.initialize({options:e})}function rb(t,e){const n=(e==null?void 0:e.persistence)||[],r=(Array.isArray(n)?n:[n]).map(bt);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function ib(t,e,n){const r=Ai(t);W(r._canInitEmulator,r,"emulator-config-failed"),W(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!!(n!=null&&n.disableWarnings),o=Hu(e),{host:s,port:a}=ob(e),l=a===null?"":`:${a}`;r.config.emulator={url:`${o}//${s}${l}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:s,port:a,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:i})}),i||sb()}function Hu(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function ob(t){const e=Hu(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const o=i[1];return{host:o,port:ml(r.substr(o.length+1))}}else{const[o,s]=r.split(":");return{host:o,port:ml(s)}}}function ml(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function sb(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wu{constructor(e,n){this.providerId=e,this.signInMethod=n}toJSON(){return mt("not implemented")}_getIdTokenResponse(e){return mt("not implemented")}_linkToIdToken(e,n){return mt("not implemented")}_getReauthenticationResolver(e){return mt("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Tn(t,e){return Nv(t,"POST","/v1/accounts:signInWithIdp",As(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qr extends Rs{constructor(){super(...arguments),this.scopes=[]}addScope(e){return this.scopes.includes(e)||this.scopes.push(e),this}getScopes(){return[...this.scopes]}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt extends qr{constructor(){super("facebook.com")}static credential(e){return sn._fromParams({providerId:Nt.PROVIDER_ID,signInMethod:Nt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Nt.credentialFromTaggedObject(e)}static credentialFromError(e){return Nt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Nt.credential(e.oauthAccessToken)}catch{return null}}}Nt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Nt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lt extends qr{constructor(){super("github.com")}static credential(e){return sn._fromParams({providerId:Lt.PROVIDER_ID,signInMethod:Lt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Lt.credentialFromTaggedObject(e)}static credentialFromError(e){return Lt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Lt.credential(e.oauthAccessToken)}catch{return null}}}Lt.GITHUB_SIGN_IN_METHOD="github.com";Lt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cb(t,e,n=!1){const{auth:r}=t;if(gt(r.app))return Promise.reject(rn(r));const i="reauthenticate";try{const o=await ur(t,zu(r,i,e,t),n);W(o.idToken,r,"internal-error");const s=Os(o.idToken);W(s,r,"internal-error");const{sub:a}=s;return W(t.uid===a,r,"user-mismatch"),Pn._forOperation(t,i,o)}catch(o){throw(o==null?void 0:o.code)==="auth/user-not-found"&&ct(r,"user-mismatch"),o}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ub(t,e,n=!1){if(gt(t.app))return Promise.reject(rn(t));const r="signIn",i=await zu(t,r,e),o=await Pn._fromIdTokenResponse(t,r,i);return n||await t._updateCurrentUser(o.user),o}function db(t,e,n,r){return $n(t).onIdTokenChanged(e,n,r)}function fb(t,e,n){return $n(t).beforeAuthStateChanged(e,n)}const si="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function td(t,e){return e?bt(e):(W(t._popupRedirectResolver,t,"argument-error"),t._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nd{constructor(e,n,r,i,o=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=o,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(n)?n:[n]}execute(){return new Promise(async(e,n)=>{this.pendingPromise={resolve:e,reject:n};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:n,sessionId:r,postBody:i,tenantId:o,error:s,type:a}=e;if(s){this.reject(s);return}const l={auth:this.auth,requestUri:n,sessionId:r,tenantId:o||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(l))}catch(c){this.reject(c)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Ab;case"linkViaPopup":case"linkViaRedirect":return Pb;case"reauthViaPopup":case"reauthViaRedirect":return Ob;default:ct(this.auth,"internal-error")}}resolve(e){_t(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){_t(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Hb(t,e={}){return Dn(t,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xb=new Sr(5e3,15e3),Zb="__/auth/iframe",ey="emulator/auth/iframe",ty={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},ny=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function ry(t){const e=t.config;W(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Cs(e,ey):`https://${t.config.authDomain}/${Zb}`,r={apiKey:e.apiKey,appName:t.name,v:wr},i=ny.get(t.config.apiHost);i&&(r.eid=i);const o=t._getFrameworks();return o.length&&(r.fw=o.join(",")),`${n}?${_r(r).slice(1)}`}async function iy(t){const e=await Qb(t),n=at().gapi;return W(n,t,"internal-error"),e.open({where:document.body,url:ry(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:ty,dontclear:!0},r=>new Promise(async(i,o)=>{await r.restyle({setHideOnLeave:!1});const s=Xe(t,"network-request-failed"),a=at().setTimeout(()=>{o(s)},Xb.get());function l(){at().clearTimeout(a),i(r)}r.ping(l).then(l,()=>{o(s)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fy="__/auth/handler",hy="emulator/auth/handler",py=encodeURIComponent("fac");async function ql(t,e,n,r,i,o){W(t.config.authDomain,t,"auth-domain-config-required"),W(t.config.apiKey,t,"invalid-api-key");const s={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:wr,eventId:i};if(e instanceof Rs){e.setDefaultLanguage(t.languageCode),s.providerId=e.providerId||"",mm(e.getCustomParameters())||(s.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries(o||{}))s[u]=d}if(e instanceof qr){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(s.scopes=u.join(","))}t.tenantId&&(s.tid=t.tenantId);const a=s;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const l=await t._getAppCheckToken(),c=l?`#${py}=${encodeURIComponent(l)}`:"";return`${gy(t)}?${_r(a).slice(1)}${c}`}function gy({config:t}){return t.emulator?Cs(t,hy):`https://${t.authDomain}/${fy}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yy(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function _y(t){lr(new On("auth",(e,{options:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),o=e.getProvider("app-check-internal"),{apiKey:s,authDomain:a}=r.options;W(s&&!s.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:s,authDomain:a,clientPlatform:t,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Bu(t)},c=new Qv(r,i,o,l);return rb(c,n),c},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,n,r)=>{e.getProvider("auth-internal").initialize()})),lr(new On("auth-internal",e=>{const n=Ai(e.getProvider("auth").getImmediate());return(r=>new by(r))(n)},"PRIVATE").setInstantiationMode("EXPLICIT")),qn(El,Il,yy(t)),qn(El,Il,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wy=5*60,Sy=_u("authIdTokenMaxAge")||wy;let Tl=null;const qy=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>Sy)return;const i=n==null?void 0:n.token;Tl!==i&&(Tl=i,await fetch(t,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function Ey(t=mv()){const e=Eu(t,"auth");if(e.isInitialized())return e.getImmediate();const n=nb(t,{popupRedirectResolver:vy,persistence:[Cb,mb,Yu]}),r=_u("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const o=new URL(r,location.origin);if(location.origin===o.origin){const s=qy(o.toString());fb(n,s,()=>s(n.currentUser)),db(n,a=>s(a))}}const i=om("auth");return i&&ib(n,`http://${i}`),n}function Iy(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}Xv({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=i=>{const o=Xe("internal-error");o.customData=i,n(o)},r.type="text/javascript",r.charset="UTF-8",Iy().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});_y("Browser");const un=(t,e)=>{const n=t.__vccOpts||t;for(const[r,i]of e)n[r]=i;return n},ut=t=>(rs("data-v-91b0998a"),t=t(),is(),t),Ty={class:"container p-0",style:{margin:"0px"}},ky={class:"card p-2 shadow border-0 m-1"},Cy=ut(()=>m("h4",null,[m("strong",null,"We are a community of Indians Abroad")],-1)),Ay=ut(()=>m("p",{class:"arvo-regular"},"Join us, and let’s make the world a smaller, more connected place for Indians everywhere.",-1)),Oy=ut(()=>m("button",{type:"button",class:"btn btn-outline-primary",style:{width:"100%"}},"Profile",-1)),Py=ut(()=>m("hr",null,null,-1)),xy={class:"nav nav-pills flex-column mb-auto"},Ry=ut(()=>m("i",{class:"fa-regular fa-newspaper me-2",style:{color:"#337357"}},null,-1)),Ny={class:"nav-item"},Ly=ut(()=>m("i",{class:"fa-regular fa-comments me-2",style:{color:"#EE4266"}},null,-1)),$y=ut(()=>m("i",{class:"fa-solid fa-bookmark me-2",style:{color:"#FFD23F"}},null,-1)),Dy=ut(()=>m("i",{class:"fa-solid fa-handshake-angle me-2",style:{color:"#337357"}},null,-1)),My=ut(()=>m("i",{class:"fa-solid fa-address-card me-2",style:{color:"#FFD23F"}},null,-1)),jy=ut(()=>m("i",{class:"fa-solid fa-address-book me-2",style:{color:"#5E1675"}},null,-1)),Fy={__name:"NavBody",setup(t){const e=br();let n=de(localStorage.getItem("auth-token"));const r=()=>{const o=new pt;Rb(Ey(),o).then(s=>{localStorage.setItem("name",s.user.displayName),localStorage.setItem("image",s.user.photoURL),localStorage.setItem("email",s.user.email),e.state.image=s.user.photoURL,fetch("https://test-am3oxfhvvq-em.a.run.app/google/login",{method:"POST",Allow:["GET","POST","OPTIONS"],headers:{"Content-type":"application/json"},body:JSON.stringify({token:s.user.accessToken})}).then(a=>{if(!a.ok)throw new Error("Network response was not ok");return a.json()}).then(a=>{a.state==0&&(localStorage.setItem("auth-token",a.token),localStorage.setItem("role",a.role),alert("Logged In"),n.value=!0)}).catch(a=>{console.error("There was a problem with the fetch operation:",a)})})};function i(){localStorage.removeItem("auth-token"),localStorage.removeItem("role"),localStorage.removeItem("name"),localStorage.removeItem("image"),localStorage.removeItem("email"),n.value=null,e.state.image=null}return(o,s)=>{const a=ss("router-link");return U(),Y("div",Ty,[m("div",ky,[Cy,Ay,D(n)?(U(),Ue(a,{key:0,to:"/profile"},{default:Le(()=>[Oy]),_:1})):st("",!0),D(n)?(U(),Y("button",{key:1,type:"button",class:"btn btn-outline-secondary mt-2",style:{width:"100%"},onClick:i},"Logout")):st("",!0),D(n)?st("",!0):(U(),Y("button",{key:2,type:"button",class:"login-with-google-btn shadow",style:{width:"100%"},onClick:r}," Sign in with Google "))]),Py,m("ul",xy,[m("li",null,[re(a,{to:"/",class:"nav-link link-body-emphasis"},{default:Le(()=>[Ry,ht(" News ")]),_:1})]),m("li",Ny,[re(a,{to:"/discusion",class:"nav-link link-body-emphasis"},{default:Le(()=>[Ly,ht(" Discusions ")]),_:1})]),m("li",null,[D(n)?(U(),Ue(a,{key:0,to:"/saved",class:"nav-link link-body-emphasis"},{default:Le(()=>[$y,ht(" Saved ")]),_:1})):st("",!0)]),m("li",null,[re(a,{to:"/help",class:"nav-link link-body-emphasis"},{default:Le(()=>[Dy,ht(" Help ")]),_:1})]),m("li",null,[re(a,{to:"/about",class:"nav-link link-body-emphasis"},{default:Le(()=>[My,ht(" About ")]),_:1})]),m("li",null,[re(a,{to:"/",class:"nav-link link-body-emphasis"},{default:Le(()=>[jy,ht(" Contact ")]),_:1})])])])}}},od=un(Fy,[["__scopeId","data-v-91b0998a"]]),Ir=t=>(rs("data-v-19fa9765"),t=t(),is(),t),Uy={class:"navbar shadow fixed-top p-2 border-bottom",style:{"background-color":"#000000"}},Vy={class:"container align-items-center",style:{"grid-template-columns":"1fr 2fr"}},By={class:"d-flex align-items-center"},Hy=["src"],Wy={key:1,class:"avatar-img rounded-circle",height:"38px",src:Ug,alt:"Bharat Guild"},zy=Ir(()=>m("label",{for:"checkbox",class:"checkbox-label"},[m("i",{class:"fas fa-moon"}),m("i",{class:"fas fa-sun"}),m("span",{class:"ball"})],-1)),Gy={class:"d-flex align-items-center"},Ky={class:"input-group-text me-3",style:{padding:"1px 6px"}},Jy=Ir(()=>m("i",{class:"fa-solid fa-magnifying-glass"},null,-1)),Yy={class:"input-group-text me-3",style:{padding:"1px 6px"}},Qy=Ir(()=>m("i",{class:"fa-solid fa-bell"},null,-1)),Xy={key:0,class:"rounded border-0","data-bs-toggle":"offcanvas","data-bs-target":"#offcanvasNavbar","aria-controls":"offcanvasNavbar","aria-label":"Toggle navigation"},Zy=Ir(()=>m("i",{class:"fa-solid fa-bars"},null,-1)),e_=[Zy],t_={class:"offcanvas offcanvas-end",tabindex:"-1",id:"offcanvasNavbar","aria-labelledby":"offcanvasNavbarLabel",style:{width:"60vw"}},n_=Ir(()=>m("div",{class:"offcanvas-header"},[m("h4",{class:"offcanvas-title",id:"offcanvasNavbarLabel"},[m("strong",null,"Bharat Guild")]),m("button",{type:"button",class:"btn-close","data-bs-dismiss":"offcanvas","aria-label":"Close"})],-1)),r_={class:"offcanvas-body p-1"},i_={__name:"NavBar",setup(t){const e=br(),{width:n,height:r}=pu(),i=Yg();St(()=>{const l=localStorage.getItem("mode");l?l=="dark"&&document.getElementById("checkbox").click():i?document.getElementById("checkbox").click():localStorage.setItem("mode","light")});function o(){localStorage.setItem("mode","light");let l=document.querySelector("body");l.dataset.bsTheme="light"}function s(){localStorage.setItem("mode","dark");let l=document.querySelector("body");l.dataset.bsTheme="dark"}function a(){localStorage.getItem("mode")=="dark"?o():s()}return(l,c)=>{const u=ss("router-link");return U(),Y("nav",Uy,[m("div",Vy,[m("div",By,[re(u,{to:"/",style:{"margin-right":"1rem"}},{default:Le(()=>[D(e).state.image?(U(),Y("img",{key:0,class:"avatar-img rounded-circle",height:"38px",src:D(e).state.image,alt:"Bharat Guild"},null,8,Hy)):(U(),Y("img",Wy))]),_:1}),m("div",{class:"flex-shrink-0",style:{"margin-right":"1rem"}},[m("div",null,[m("input",{type:"checkbox",class:"checkbox",id:"checkbox",onClick:a}),zy])])]),m("div",Gy,[m("span",Ky,[re(u,{to:"/search",class:"link-body-emphasis"},{default:Le(()=>[Jy]),_:1})]),m("span",Yy,[re(u,{to:"/notifications",class:"link-body-emphasis"},{default:Le(()=>[Qy]),_:1})]),D(n)<850?(U(),Y("button",Xy,e_)):st("",!0),m("div",t_,[n_,m("div",r_,[re(od)])])])])])}}},o_=un(i_,[["__scopeId","data-v-19fa9765"]]),s_={},a_={class:"container",style:{margin:"0px",width:"325px"}},l_=fs('<div class="card mb-3"><div class="card-header p-2 border-0 text-center"><h5 class="card-title mb-0">Latest News</h5></div><div class="card-body"><div class="list-group list-group-flush border-bottom scrollarea"><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a></div><div class="d-grid mt-3"><a class="btn btn-sm btn-primary-soft" href="#!">View more</a></div></div></div><div class="card"><div class="card-header p-2 border-0 text-center"><h5 class="card-title mb-0">Top Discussions</h5></div><div class="card-body"><div class="list-group list-group-flush border-bottom scrollarea"><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a><a href="#" class="list-group-item list-group-item-action p-1 lh-sm"><div class="d-flex w-100 align-items-center justify-content-between"><strong class="mb-1">List group item heading</strong><small>Wed</small></div><div class="col-10 mb-1 small">Some placeholder content in a paragraph below the heading and date.</div></a></div><div class="d-grid mt-3"><a class="btn btn-sm btn-primary-soft" href="#!">View more</a></div></div></div>',2),c_=[l_];function u_(t,e){return U(),Y("div",a_,c_)}const d_=un(s_,[["render",u_]]),f_={key:0,class:"d-flex justify-content-center m-auto"},h_={__name:"App",setup(t){const{width:e,height:n}=pu(),r=br(),i=ws();let o=de(!0),s=de(0);return St(async()=>{r.state.isDataLoaded==!1&&(await r.dispatch("getArticles"),await r.dispatch("getDiscusions"))}),Ve(i,(a,l)=>{o.value=!o.value,s.value+=1}),(a,l)=>(U(),Y(Te,null,[(U(),Ue(o_,{key:D(o)})),D(e)>849?(U(),Y("div",f_,[(U(),Ue(od,{style:{"margin-top":"6rem",width:"250px"},key:D(o)})),(U(),Ue(D(Po),{key:D(s),style:{width:"650px"}})),re(d_,{style:{"margin-top":"6rem"}})])):(U(),Ue(D(Po),{key:D(s)}))],64))}},p_="modulepreload",g_=function(t){return"/IndiansAbroad/"+t},kl={},He=function(e,n,r){let i=Promise.resolve();if(n&&n.length>0){const o=document.getElementsByTagName("link");i=Promise.all(n.map(s=>{if(s=g_(s),s in kl)return;kl[s]=!0;const a=s.endsWith(".css"),l=a?'[rel="stylesheet"]':"";if(!!r)for(let d=o.length-1;d>=0;d--){const f=o[d];if(f.href===s&&(!a||f.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${s}"]${l}`))return;const u=document.createElement("link");if(u.rel=a?"stylesheet":p_,a||(u.as="script",u.crossOrigin=""),u.href=s,document.head.appendChild(u),a)return new Promise((d,f)=>{u.addEventListener("load",d),u.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${s}`)))})}))}return i.then(()=>e()).catch(o=>{const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=o,window.dispatchEvent(s),!s.defaultPrevented)throw o})},m_=t=>(rs("data-v-28c39adc"),t=t(),is(),t),v_={class:"row d-flex justify-content-center p-2"},b_={class:"btn-group",role:"group","aria-label":"Basic checkbox toggle button group"},y_=m_(()=>m("p",{class:"text-center"},"Check content based on senstivity",-1)),__={__name:"CheckBox",emits:["inFocus","filterData"],setup(t,{emit:e}){let n=de(!0),r=de(!0),i=de(!0),o=de(!0);const s=e;function a(){s("filterData",{v:n.value,p:r.value,r:i.value,o:o.value})}return(l,c)=>(U(),Y("div",v_,[m("div",b_,[(U(),Y("label",{class:Dt(["btn",{"btn-danger":D(n),"btn-outline-danger":!D(n)}]),onClick:c[0]||(c[0]=u=>{_e(n)?n.value=!D(n):n=!D(n),a()}),key:D(n)},"Voilent",2)),(U(),Y("label",{class:Dt(["btn",{"btn-warning":D(r),"btn-outline-warning":!D(r)}]),onClick:c[1]||(c[1]=u=>{_e(r)?r.value=!D(r):r=!D(r),a()}),key:D(r)},"Political",2)),(U(),Y("label",{class:Dt(["btn",{"btn-success":D(i),"btn-outline-success":!D(i)}]),onClick:c[2]||(c[2]=u=>{_e(i)?i.value=!D(i):i=!D(i),a()}),key:D(i)},"Religion",2)),(U(),Y("label",{class:Dt(["btn",{"btn-primary":D(o),"btn-outline-primary":!D(o)}]),onClick:c[3]||(c[3]=u=>{_e(o)?o.value=!D(o):o=!D(o),a()}),key:D(o)},"Success",2))]),y_]))}},w_=un(__,[["__scopeId","data-v-28c39adc"]]),S_={},q_={id:"container1"},E_=fs('<div id="objects" data-v-fd68ca9b><a class="nav-link object" data-v-fd68ca9b>Germany</a><a class="nav-link object" href="#" data-v-fd68ca9b>Uk</a><a class="nav-link object" href="#" data-v-fd68ca9b>Russia</a><a class="nav-link object" href="#" data-v-fd68ca9b>Italy</a><a class="nav-link object" href="#" data-v-fd68ca9b>Australia</a><a class="nav-link object" href="#" data-v-fd68ca9b>Germany</a><a class="nav-link object" href="#" data-v-fd68ca9b>Uk</a><a class="nav-link object" href="#" data-v-fd68ca9b>Russia</a><a class="nav-link object" href="#" data-v-fd68ca9b>Italy</a><a class="nav-link object" href="#" data-v-fd68ca9b>Australia</a></div>',1),I_=[E_];function T_(t,e){return U(),Y("div",q_,I_)}const k_=un(S_,[["render",T_],["__scopeId","data-v-fd68ca9b"]]),C_={},A_={class:"card","aria-hidden":"true"},O_=fs('<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJztHLBqLX7gIZz4ZFSTq7ADz1hhicBg0gDuB7E4bAgQ&amp;s" class="card-img-top" alt="..."><div class="card-body"><h5 class="card-title placeholder-glow"><span class="placeholder col-6"></span></h5><p class="card-text placeholder-glow"><span class="placeholder col-7"></span><span class="placeholder col-4"></span><span class="placeholder col-4"></span><span class="placeholder col-6"></span><span class="placeholder col-8"></span></p><a class="btn btn-primary disabled placeholder col-6" aria-disabled="true"></a></div>',2),P_=[O_];function x_(t,e){return U(),Y("div",A_,P_)}const Cl=un(C_,[["render",x_]]),R_={class:"d-flex gap-3 border-0 p-1 justify-content-between","aria-current":"true"},N_=m("img",{src:"https://images.unsplash.com/photo-1510227272981-87123e259b17?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=3759e09a5b9fbe53088b23c615b6312e",alt:"twbs",width:"28",height:"28",class:"rounded-circle flex-shrink-0"},null,-1),L_={class:"d-flex gap-2 w-100 justify-content-between"},$_={class:"d-flex"},D_={class:"mb-0"},M_=m("small",{class:"opacity-50 text-nowrap ms-2"},"now",-1),j_={class:"mb-0 opacity-75"},F_={class:"d-flex row justify-content-center p-2"},U_={key:0,class:"fa-solid fa-heart p-1",style:{color:"#ea3e13"}},V_=m("small",{class:"opacity-75 text-nowrap p-1"},"100",-1),Al={__name:"CommentCard",props:{name:String,time:String,content:String},setup(t){return(e,n)=>(U(),Y("div",R_,[N_,m("div",L_,[m("div",null,[m("div",$_,[m("h6",D_,_n(t.name),1),M_]),m("p",j_,_n(t.content),1)])]),m("div",F_,[(U(),Y("i",U_)),V_])]))}};function dr(t){"@babel/helpers - typeof";return dr=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},dr(t)}function Ol(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function Pl(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?Ol(Object(n),!0).forEach(function(r){B_(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):Ol(Object(n)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function B_(t,e,n){return e=H_(e),e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function H_(t){var e=W_(t,"string");return dr(e)=="symbol"?e:String(e)}function W_(t,e){if(dr(t)!="object"||!t)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var r=n.call(t,e||"default");if(dr(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function z_(t){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:!0;wi()?St(t):e?t():mr(t)}var G_=0;function sd(t){var e=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=de(!1),r=de(t),i=de(null),o=Yt.isClient()?window.document:void 0,s=e.document,a=s===void 0?o:s,l=e.immediate,c=l===void 0?!0:l,u=e.manual,d=u===void 0?!1:u,f=e.name,g=f===void 0?"style_".concat(++G_):f,b=e.id,S=b===void 0?void 0:b,x=e.media,k=x===void 0?void 0:x,R=e.nonce,j=R===void 0?void 0:R,H=e.props,K=H===void 0?{}:H,L=function(){},Q=function(X){var he=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};if(a){var N=Pl(Pl({},K),he),oe=N.name||g,Ee=N.id||S,Ke=N.nonce||j;i.value=a.querySelector('style[data-primevue-style-id="'.concat(oe,'"]'))||a.getElementById(Ee)||a.createElement("style"),i.value.isConnected||(r.value=X||t,Yt.setAttributes(i.value,{type:"text/css",id:Ee,media:k,nonce:Ke}),a.head.appendChild(i.value),Yt.setAttribute(i.value,"data-primevue-style-id",g),Yt.setAttributes(i.value,N)),!n.value&&(L=Ve(r,function(ye){i.value.textContent=ye},{immediate:!0}),n.value=!0)}},M=function(){!a||!n.value||(L(),Yt.isExist(i.value)&&a.head.removeChild(i.value),n.value=!1)};return c&&!d&&z_(Q),{id:S,name:g,css:r,unload:M,load:Q,isLoaded:Xo(n)}}function fr(t){"@babel/helpers - typeof";return fr=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},fr(t)}function K_(t,e){return X_(t)||Q_(t,e)||Y_(t,e)||J_()}function J_(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function Y_(t,e){if(t){if(typeof t=="string")return xl(t,e);var n=Object.prototype.toString.call(t).slice(8,-1);if(n==="Object"&&t.constructor&&(n=t.constructor.name),n==="Map"||n==="Set")return Array.from(t);if(n==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))return xl(t,e)}}function xl(t,e){(e==null||e>t.length)&&(e=t.length);for(var n=0,r=new Array(e);n<e;n++)r[n]=t[n];return r}function Q_(t,e){var n=t==null?null:typeof Symbol<"u"&&t[Symbol.iterator]||t["@@iterator"];if(n!=null){var r,i,o,s,a=[],l=!0,c=!1;try{if(o=(n=n.call(t)).next,e===0){if(Object(n)!==n)return;l=!1}else for(;!(l=(r=o.call(n)).done)&&(a.push(r.value),a.length!==e);l=!0);}catch(u){c=!0,i=u}finally{try{if(!l&&n.return!=null&&(s=n.return(),Object(s)!==s))return}finally{if(c)throw i}}return a}}function X_(t){if(Array.isArray(t))return t}function Rl(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function io(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?Rl(Object(n),!0).forEach(function(r){Z_(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):Rl(Object(n)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function Z_(t,e,n){return e=ew(e),e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function ew(t){var e=tw(t,"string");return fr(e)=="symbol"?e:String(e)}function tw(t,e){if(fr(t)!="object"||!t)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var r=n.call(t,e||"default");if(fr(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var nw=`
.p-hidden-accessible {
    border: 0;
    clip: rect(0 0 0 0);
    height: 1px;
...
`,mw={root:"p-editor-container",toolbar:"p-editor-toolbar",content:"p-editor-content"},Dl=$s.extend({name:"editor",css:gw,classes:mw}),vw={name:"BaseEditor",extends:pw,props:{modelValue:String,placeholder:String,readonly:Boolean,formats:Array,editorStyle:null,modules:null},style:Dl,provide:function(){return{$parentInstance:this}},beforeMount:function(){var e;Dl.loadStyle({nonce:(e=this.$primevue)===null||e===void 0||(e=e.config)===null||e===void 0||(e=e.csp)===null||e===void 0?void 0:e.nonce})}};function gr(t){"@babel/helpers - typeof";return gr=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},gr(t)}function Ml(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);e&&(r=r.filter(function(i){return Object.getOwnPropertyDescriptor(t,i).enumerable})),n.push.apply(n,r)}return n}function bw(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?Ml(Object(n),!0).forEach(function(r){yw(t,r,n[r])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):Ml(Object(n)).forEach(function(r){Object.defineProperty(t,r,Object.getOwnPropertyDescriptor(n,r))})}return t}function yw(t,e,n){return e=_w(e),e in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function _w(t){var e=ww(t,"string");return gr(e)=="symbol"?e:String(e)}function ww(t,e){if(gr(t)!="object"||!t)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var r=n.call(t,e||"default");if(gr(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var jl=function(){try{return window.Quill}catch{return null}}(),ud={name:"Editor",extends:vw,inheritAttrs:!1,emits:["update:modelValue","text-change","selection-change","load"],data:function(){return{reRenderColorKey:0}},quill:null,watch:{modelValue:function(e,n){e!==n&&this.quill&&!this.quill.hasFocus()&&(this.reRenderColorKey++,this.renderValue(e))},readonly:function(){this.handleReadOnlyChange()}},mounted:function(){var e=this,n={modules:bw({toolbar:this.$refs.toolbarElement},this.modules),readOnly:this.readonly,theme:"snow",formats:this.formats,placeholder:this.placeholder};jl?(this.quill=new jl(this.$refs.editorElement,n),this.initQuill(),this.handleLoad()):He(()=>import("./quill-CyBI07AH.js").then(r=>r.q),__vite__mapDeps([])).then(function(r){r&&Yt.isExist(e.$refs.editorElement)&&(r.default?e.quill=new r.default(e.$refs.editorElement,n):e.quill=new r(e.$refs.editorElement,n),e.initQuill())}).then(function(){e.handleLoad()})},beforeUnmount:function(){this.quill=null},methods:{renderValue:function(e){this.quill&&(e?this.quill.setContents(this.quill.clipboard.convert(e)):this.quill.setText(""))},initQuill:function(){var e=this;this.renderValue(this.modelValue),this.quill.on("text-change",function(n,r,i){if(i==="user"){var o=e.$refs.editorElement.children[0].innerHTML,s=e.quill.getText().trim();o==="<p><br></p>"&&(o=""),e.$emit("update:modelValue",o),e.$emit("text-change",{htmlValue:o,textValue:s,delta:n,source:i,instance:e.quill})}}),this.quill.on("selection-change",function(n,r,i){var o=e.$refs.editorElement.children[0].innerHTML,s=e.quill.getText().trim();e.$emit("selection-change",{htmlValue:o,textValue:s,range:n,oldRange:r,source:i,instance:e.quill})})},handleLoad:function(){this.quill&&this.quill.getModule("toolbar")&&this.$emit("load",{instance:this.quill})},handleReadOnlyChange:function(){this.quill&&this.quill.enable(!this.readonly)}}};function Sw(t,e,n,r,i,o){return U(),Y("div",ee({class:t.cx("root")},t.ptmi("root")),[m("div",ee({ref:"toolbarElement",class:t.cx("toolbar")},t.ptm("toolbar")),[kc(t.$slots,"toolbar",{},function(){return[m("span",ee({class:"ql-formats"},t.ptm("formats")),[m("select",ee({class:"ql-header",defaultValue:"0"},t.ptm("header")),[m("option",ee({value:"1"},t.ptm("option")),"Heading",16),m("option",ee({value:"2"},t.ptm("option")),"Subheading",16),m("option",ee({value:"0"},t.ptm("option")),"Normal",16)],16),m("select",ee({class:"ql-font"},t.ptm("font")),[m("option",Wd(Fc(t.ptm("option"))),null,16),m("option",ee({value:"serif"},t.ptm("option")),null,16),m("option",ee({value:"monospace"},t.ptm("option")),null,16)],16)],16),m("span",ee({class:"ql-formats"},t.ptm("formats")),[m("button",ee({class:"ql-bold",type:"button"},t.ptm("bold")),null,16),m("button",ee({class:"ql-italic",type:"button"},t.ptm("italic")),null,16),m("button",ee({class:"ql-underline",type:"button"},t.ptm("underline")),null,16)],16),(U(),Y("span",ee({key:i.reRenderColorKey,class:"ql-formats"},t.ptm("formats")),[m("select",ee({class:"ql-color"},t.ptm("color")),null,16),m("select",ee({class:"ql-background"},t.ptm("background")),null,16)],16)),m("span",ee({class:"ql-formats"},t.ptm("formats")),[m("button",ee({class:"ql-list",value:"ordered",type:"button"},t.ptm("list")),null,16),m("button",ee({class:"ql-list",value:"bullet",type:"button"},t.ptm("list")),null,16),m("select",ee({class:"ql-align"},t.ptm("select")),[m("option",ee({defaultValue:""},t.ptm("option")),null,16),m("option",ee({value:"center"},t.ptm("option")),null,16),m("option",ee({value:"right"},t.ptm("option")),null,16),m("option",ee({value:"justify"},t.ptm("option")),null,16)],16)],16),m("span",ee({class:"ql-formats"},t.ptm("formats")),[m("button",ee({class:"ql-link",type:"button"},t.ptm("link")),null,16),m("button",ee({class:"ql-image",type:"button"},t.ptm("image")),null,16),m("button",ee({class:"ql-code-block",type:"button"},t.ptm("codeBlock")),null,16)],16),m("span",ee({class:"ql-formats"},t.ptm("formats")),[m("button",ee({class:"ql-clean",type:"button"},t.ptm("clean")),null,16)],16)]})],16),m("div",ee({ref:"editorElement",class:t.cx("content"),style:t.editorStyle},t.ptm("content")),null,16)],16)}ud.render=Sw;const qw={class:"container"},Ew={class:"list-group list-group-flush",style:{"margin-bottom":"2rem"}},Iw={class:"d-flex flex-row justify-content-between align-items-center"},Tw={class:"col d-flex flex-column position-static"},kw={class:"d-flex justify-content-around"},Cw=["onClick"],Aw=["onClick"],Ow={class:"d-flex flex-row justify-content-between align-items-center"},Pw={class:"col d-flex flex-column position-static"},xw=["onClick"],Rw={class:"modal fade",id:"exampleModal",tabindex:"-1","aria-labelledby":"exampleModalLabel","aria-hidden":"true"},Nw={class:"modal-dialog"},Lw={class:"modal-content"},$w=m("div",{class:"modal-header"},[m("h1",{class:"modal-title fs-5",id:"exampleModalLabel"},"Comment"),m("button",{type:"button",class:"btn-close","data-bs-dismiss":"modal","aria-label":"Close"})],-1),Dw={class:"modal-body"},Mw={class:"alert alert-warning alert-dismissible m-0 p-1 mb-1",role:"alert",key:"alert"},jw={class:"ms-1"},Fw=m("span",{class:"ql-formats"},[m("select",{class:"ql-size"})],-1),Uw=m("span",{class:"ql-formats"},[m("button",{class:"ql-bold"}),m("button",{class:"ql-italic"})],-1),Vw=m("span",{class:"ql-formats"},[m("button",{class:"ql-list",value:"ordered"}),m("button",{class:"ql-list",value:"bullet"})],-1),Bw=m("span",{class:"ql-formats"},[m("button",{class:"ql-link"}),m("button",{class:"ql-clean"})],-1),Hw=m("button",{type:"button",class:"btn btn-secondary","data-bs-dismiss":"modal"},"Close",-1),Ww={__name:"CommentSection",props:["id"],setup(t){const e=t;let n=de([]),r=de(""),i=de(""),o=de(-1),s=de(!0),a=de("");function l(d,f){r.value=d,o.value=f,s.value=!1}St(async()=>{const d=`https://test-am3oxfhvvq-em.a.run.app/article/comments/${e.id}`,f=await fetch(d,{method:"GET",Allow:["GET","POST"],headers:{"Content-Type":"application/json"}}),g=await f.json();if(f.ok){for(const b of g)n.value.push({id:b.id,content:b.content,likes_count:b.likes_count,username:b.username,image:b.image,replies:[]});console.log(n)}});async function c(){if(c.value=="")alert("type first");else{const f=await fetch("https://test-am3oxfhvvq-em.a.run.app/comment",{method:"POST",Allow:["GET","POST"],headers:{"Authentication-Token":localStorage.getItem("auth-token"),"Content-Type":"application/json"},body:JSON.stringify({article:e.id,parent:o.value,content:i.value})});await f.json(),f.ok&&(o!=-1?n.value.filter(g=>g.id==o)[0].replies.push({content:i.value,likes_count:0,username:localStorage.getItem("name"),image:localStorage.getItem("image")}):n.value.push({id:e.id,content:i.value,likes_count:0,username:localStorage.getItem("name"),image:localStorage.getItem("image")}))}}async function u(d){const f=await fetch(`https://test-am3oxfhvvq-em.a.run.app/nested/comments/${d}`,{method:"GET",headers:{"Content-type":"application/json"}}),g=await f.json();f.ok&&(n.value.filter(b=>b.id==d)[0].replies=g)}return(d,f)=>(U(),Y("div",qw,[m("ul",Ew,[(U(!0),Y(Te,null,bo(D(n),(g,b)=>(U(),Y("li",{class:"list-group-item mt-2 p-1",key:b},[m("div",Iw,[m("div",null,[m("div",Tw,[re(Al,{name:g.username,time:"2 days ago",content:g.content},null,8,["name","content"]),m("div",kw,[m("div",null,[m("a",{class:"opacity-50 text-nowrap",onClick:S=>u(g.id)},"--- View 3 more replies",8,Cw)]),m("small",{class:"opacity-75 text-nowrap ms-2",onClick:S=>l(g.username,g.id),"data-bs-toggle":"modal","data-bs-target":"#exampleModal"},"Reply",8,Aw)]),(U(!0),Y(Te,null,bo(g.replies,S=>(U(),Y("div",{class:"card-body ms-4",style:{padding:"12px"},key:S.content},[m("div",Ow,[m("div",null,[m("div",Pw,[re(Al,{name:S.username,time:"2 days ago",content:S.content},null,8,["name","content"]),m("small",{class:"opacity-75 text-nowrap",onClick:x=>l(S.username,g.id),style:{"margin-left":"50px"},"data-bs-toggle":"modal","data-bs-target":"#exampleModal"},"Reply",8,xw)])])])]))),128))])])])]))),128))]),m("div",Rw,[m("div",Nw,[m("div",Lw,[$w,m("div",Dw,[D(s)?st("",!0):(U(),Y("div",Mw,[m("span",jw,"Replying to "+_n(D(r)),1),m("span",{class:"btn-close p-2",onClick:f[0]||(f[0]=g=>{_e(s)?s.value=!0:s=!0,_e(r)?r.value="":r="",_e(o)?o.value=-1:o=-1})})])),re(D(ud),{modelValue:D(a),"onUpdate:modelValue":f[1]||(f[1]=g=>_e(a)?a.value=g:a=g),editorStyle:"height: 20vh;"},{toolbar:Le(()=>[Fw,Uw,Vw,Bw]),_:1},8,["modelValue"])]),m("div",{class:"modal-footer"},[Hw,m("button",{type:"button",class:"btn btn-primary",onClick:c},"Comment")])])])])]))}},zw={},Gw={"data-bs-toggle":"modal","data-bs-target":"#exampleModal"},Kw=m("div",{class:"modal",id:"exampleModal",tabindex:"-1","aria-labelledby":"exampleModalLabel","aria-hidden":"true",role:"dialog"},[m("div",{class:"modal-dialog",role:"document"},[m("div",{class:"modal-content rounded-3 shadow"},[m("div",{class:"modal-body p-4 text-center"},[m("h5",{class:"mb-0"},"Login Required!"),m("p",{class:"mb-0"},"You can always change your mind in your account settings.")]),m("div",{class:"modal-footer flex-nowrap p-0"},[m("button",{type:"button",class:"btn btn-lg btn-link fs-6 text-decoration-none col-6 py-3 m-0 rounded-0 border-end"},[m("strong",null,"Login")]),m("button",{type:"button",class:"btn btn-lg btn-link fs-6 text-decoration-none col-6 py-3 m-0 rounded-0","data-bs-dismiss":"modal"},"Close")])])])],-1);function Jw(t,e){return U(),Y(Te,null,[m("div",Gw,[kc(t.$slots,"default")]),Kw],64)}const Yw=un(zw,[["render",Jw]]),Qw={class:"card mb-3 shadow-lg",style:{"max-width":"95%"}},Xw={class:"card-header"},Zw={class:"p-1 bg-info-subtle rounded-4"},e0=["src"],t0=["src"],n0={class:"card-body"},r0={class:"barlow-semibold"},i0={class:"card-text barlow-regular"},o0=m("br",null,null,-1),s0={class:"d-flex justify-content-between"},a0=["data-bs-target","aria-controls"],l0=["id"],c0=m("div",{class:"offcanvas-header"},[m("div"),m("h5",{class:"offcanvas-title text-center",id:"offcanvasBottomLabel"},[m("strong",null,"Comments")]),m("button",{type:"button",class:"btn-close","data-bs-dismiss":"offcanvas","aria-label":"Close"})],-1),u0={class:"offcanvas-body small",style:{padding:"0"}},d0=m("i",{class:"fa-regular fa-bookmark p-2 fa-lg"},null,-1),f0={__name:"NewsContent",props:{title:String,image:String,content:String,source:String,category:String,id:Number,has_liked:Boolean,has_saved:Boolean},setup(t){const e=br();ws();let n=de(!1),r=localStorage.getItem("auth-token");async function i(a){e.state.articles.filter(l=>l.id==a)[0].has_liked=!e.state.articles.filter(l=>l.id==a)[0].has_liked,await e.dispatch("likeArticle",a).then(()=>{})}async function o(a){e.state.articles.filter(l=>l.id==a)[0].has_saved=!e.state.articles.filter(l=>l.id==a)[0].has_saved,await e.dispatch("saveArticle",a).then(()=>{})}function s(){navigator.share?navigator.share({text:title,url:`https://abhijatain.github.io/Indians/article/${id}`,title:"Bharat Guild"}):(navigator.clipboard.writeText(`https://abhijatain.github.io/Indians/article/${id}`),alert("Link Copied"))}return(a,l)=>{const c=ss("router-link");return U(),Y("div",Qw,[m("div",Xw,[m("strong",Zw,_n(t.category),1)]),t.category=="stats"?(U(),Y("img",{key:0,src:t.image,class:"card-img"},null,8,e0)):(U(),Y("iframe",{key:1,style:{height:"30vh"},class:"embed-responsive-item",src:t.image,allowfullscreen:""},null,8,t0)),m("div",n0,[m("h3",r0,_n(t.title),1),m("p",i0,[ht(_n(t.content)+" ",1),re(c,{to:`article/${t.id}/${t.title}`},{default:Le(()=>[ht("Read More")]),_:1},8,["to"])]),o0,m("div",s0,[m("div",null,[t.has_liked?(U(),Y("i",{key:0,class:"fa-solid fa-heart p-2 fa-lg",onClick:l[0]||(l[0]=u=>i(t.id)),style:{color:"#FB6D48"}})):(U(),Y("i",{key:1,class:"fa-regular fa-heart p-2 fa-lg",onClick:l[1]||(l[1]=u=>i(t.id))})),m("i",{"data-bs-toggle":"offcanvas","data-bs-target":`#${t.id}`,"aria-controls":t.id,class:"fa-regular fa-comment fa-lg p-2",onClick:l[2]||(l[2]=u=>_e(n)?n.value=!D(n):n=!D(n))},null,8,a0),m("div",{class:"offcanvas offcanvas-bottom",tabindex:"-1",id:t.id,"aria-labelledby":"offcanvasBottomLabel",style:{height:"60vh"}},[c0,m("div",u0,[D(n)?(U(),Ue(Ww,{key:0,id:t.id},null,8,["id"])):st("",!0)])],8,l0),m("i",{class:"fa-solid fa-share p-2 fa-lg",onClick:l[3]||(l[3]=u=>s())})]),m("div",null,[D(r)?t.has_saved?(U(),Y("i",{key:1,class:"fa-solid fa-bookmark p-2 fa-lg",onClick:l[4]||(l[4]=u=>o(t.id))})):(U(),Y("i",{key:2,class:"fa-regular fa-bookmark p-2 fa-lg",onClick:l[5]||(l[5]=u=>o(t.id))})):(U(),Ue(Yw,{key:0},{default:Le(()=>[d0]),_:1}))])])])])}}},h0={style:{"margin-top":"4rem"}},p0={class:"container"},g0={class:"row d-flex justify-content-center"},m0={key:0,class:"container"},v0={class:"row d-flex justify-content-center"},b0={class:"card mb-5 shadow-lg",style:{"max-width":"95%"}},y0={class:"card mb-5 shadow-lg",style:{"max-width":"95%"}},_0={__name:"ArticleCard",setup(t){const e=br();let n=de([]),r=de([]);const i=ws();let o=de(!1);St(async()=>{function a(){e.state.isDataLoaded&&(console.log(e.state.articles),clearInterval(l),o.value=!0)}const l=setInterval(a,50)});function s(a){n.value=r.value,a.v==!1&&(n.value=n.value.filter(l=>l.category!="voilent")),a.p==!1&&(n.value=n.value.filter(l=>l.category!="political")),a.r==!1&&(n.value=n.value.filter(l=>l.category!="religion")),a.o==!1&&(n.value=n.value.filter(l=>l.category!="stats"))}return(a,l)=>(U(),Y("div",h0,[m("div",p0,[D(i).params.id=="all"||!D(i).params.id?(U(),Ue(k_,{key:0})):st("",!0),D(i).params.id=="all"||!D(i).params.id?(U(),Ue(w_,{key:1,onFilterData:l[0]||(l[0]=c=>s(c))})):st("",!0),m("div",g0,[(U(!0),Y(Te,null,bo(D(e).state.articles,(c,u)=>(U(),Ue(f0,{key:u,title:c.title,content:c.summary,source:c.source,image:c.youtube,id:c.id,has_liked:c.has_liked,has_saved:c.has_saved,category:c.category},null,8,["title","content","source","image","id","has_liked","has_saved","category"]))),128))])]),D(o)?st("",!0):(U(),Y("div",m0,[m("div",v0,[m("div",b0,[re(Cl)]),m("div",y0,[re(Cl)])])]))]))}},Fl={__name:"HomeView",setup(t){return(e,n)=>(U(),Y("main",null,[re(_0)]))}},w0=jg({history:gg("/IndiansAbroad/"),routes:[{path:"/",name:"home",component:Fl},{path:"/profile",name:"profile",component:()=>He(()=>import("./ProfileView-5D81dccd.js"),__vite__mapDeps([]))},{path:"/admin",name:"admin",component:()=>He(()=>import("./AdminView-CQYkMCzp.js"),__vite__mapDeps([0,1]))},{path:"/search/:content",name:"search",component:()=>He(()=>import("./SearchView-BCRI_hbL.js"),__vite__mapDeps([2,3]))},{path:"/about",name:"about",component:()=>He(()=>import("./AboutView-kzKAK0EE.js"),__vite__mapDeps([]))},{path:"/saved",name:"saved",component:()=>He(()=>import("./SavedView-DuDGcu9W.js"),__vite__mapDeps([4,5]))},{path:"/search",name:"search",component:()=>He(()=>import("./SearchView-BCRI_hbL.js"),__vite__mapDeps([2,3]))},{path:"/article/:id/:title",name:"article",component:Fl},{path:"/discusion",name:"discusion",component:()=>He(()=>import("./DiscusionView-9Rmesrwu.js"),__vite__mapDeps([6,7,8,3]))},{path:"/add/discussion",name:"add",component:()=>He(()=>import("./AddView-CPBoGBgE.js"),__vite__mapDeps([9,1,10]))},{path:"/discusion/:id/:title",name:"single",props:!0,component:()=>He(()=>import("./SingleView-CtkeYNgT.js"),__vite__mapDeps([11,12]))},{path:"/notifications",name:"notfications",component:()=>He(()=>import("./NotificationView-B5GXa2MI.js"),__vite__mapDeps([]))},{path:"/help",name:"help",component:()=>He(()=>import("./HelpView-BasO1hAP.js"),__vite__mapDeps([13,7]))}]}),S0=Mp({state(){return{image:null,articles:[],discusions:[],token:localStorage.getItem("auth-token"),isDataLoaded:!1,isDiscusionLoaded:!1}},mutations:{add_articles(t,e){t.articles=e},add_discusions(t,e){t.discusions=e},like_discusion(t,e){t.discusions.filter(n=>n.id==e)[0].has_liked=!t.discusions.filter(n=>n.id==e)[0].has_liked},save_discusion(t,e){t.discusions.filter(n=>n.id==e)[0].has_saved=!t.discusions.filter(n=>n.id==e)[0].has_saved}},actions:{async getArticles({commit:t,state:e}){const n=await fetch("https://test-am3oxfhvvq-em.a.run.app/api/article/all",{method:"GET",Allow:["GET","POST"],headers:{"Authentication-Token":e.token,"Content-Type":"application/json"}}),r=await n.json();n.ok&&(t("add_articles",r),e.isDataLoaded=!0)},async likeArticle({commit:t,state:e},n){await fetch("https://test-am3oxfhvvq-em.a.run.app/like/article",{method:"POST",Allow:["GET","POST"],headers:{"Authentication-Token":e.token,"Content-type":"application/json"},body:JSON.stringify({id:n})})},async saveArticle({commit:t,state:e},n){await fetch("https://test-am3oxfhvvq-em.a.run.app/save",{method:"POST",Allow:["GET","POST"],headers:{"Authentication-Token":e.token,"Content-type":"application/json"},body:JSON.stringify({id:n})})},async getDiscusions({commit:t,state:e}){const n=await fetch("https://test-am3oxfhvvq-em.a.run.app/api/discusion/all",{method:"GET",Allow:["GET","POST"],headers:{"Authentication-Token":e.token,"Content-Type":"application/json"}}),r=await n.json();n.ok&&(t("add_discusions",r),e.isDiscusionLoaded=!0)},async likeDiscusion({commit:t,state:e},n){await fetch("https://test-am3oxfhvvq-em.a.run.app/like/discusion",{method:"POST",Allow:["GET","POST"],headers:{"Authentication-Token":e.token,"Content-type":"application/json"},body:JSON.stringify({id:n})}),t("like_discusion",n)},async saveDiscusion({commit:t,state:e},n){await fetch("https://test-am3oxfhvvq-em.a.run.app/save/discusion",{method:"POST",Allow:["GET","POST"],headers:{"Authentication-Token":e.token,"Content-type":"application/json"},body:JSON.stringify({id:n})}),t("save_discusion",n)}},getters:{getCount(t){return t.articles}}});var q0="firebase",E0="10.10.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qn(q0,E0,"app");const I0={apiKey:"AIzaSyDDvzYMAuIceDytcmOZ6Bf28MtjrEFcOjk",authDomain:"bharat-guild-f02d0.firebaseapp.com",projectId:"bharat-guild-f02d0",storageBucket:"bharat-guild-f02d0.appspot.com",messagingSenderId:"724548591779",appId:"1:724548591779:web:da77bee042632d34f71f16",measurementId:"G-H9XNY6PEY3"};Iu(I0);const xi=op(h_);xi.use(S0);xi.use(w0);xi.use(hp);xi.mount("#app");export{_e as A,$s as B,br as C,Yt as D,D0 as E,O0 as F,rs as G,is as H,pu as I,k0 as J,L0 as K,T0 as L,Bc as M,Wd as N,te as O,Fc as P,M0 as Q,ud as R,ws as S,k_ as T,C0 as U,Ww as V,A0 as Z,un as _,fs as a,Ug as b,Y as c,Ue as d,x0 as e,m as f,kc as g,st as h,re as i,N0 as j,Le as k,Te as l,ee as m,Dt as n,U as o,bo as p,ht as q,ss as r,pw as s,_n as t,P0 as u,$0 as v,R0 as w,de as x,St as y,D as z};
