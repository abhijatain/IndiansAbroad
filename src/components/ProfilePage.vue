<template>
    <div class="card">
          <!-- Cover image -->
          <div class="h-200px rounded-top" style="background-image:url('https://img.freepik.com/free-photo/wide-angle-shot-single-tree-growing-clouded-sky-during-sunset-surrounded-by-grass_181624-22807.jpg'); background-position: center; background-size: cover; background-repeat: no-repeat;"></div>
            <!-- Card body START -->
              ...
              <div class="d-sm-flex align-items-start text-center text-sm-start">
                <div>
                  ...
                  <div class="avatar avatar-xxl mt-n5 mb-3">
                    <img class="avatar-img rounded-circle border border-white border-3" src="../assets/BharatGuildLogo.jpg" alt="">
                  </div>
                </div>
